...
public class CoinskashApplication {
	...
	CommandLineRunner run(UserService userService) {
		return args -> {
			...
			userService.saveUser(new AppUser(null, "John", "Travolta", "john@gmail.com", "Nigeria","09069167788","1234", new ArrayList<>()));
			userService.saveUser(new AppUser(null, "Will", "Smith", "will@will.com", "Niger", "09011111111","1234", new ArrayList<>()));
			userService.saveUser(new AppUser(null, "Jim", "Carry", "jim@gmail.com","Nigeria","09022321111", "1234", new ArrayList<>()));
